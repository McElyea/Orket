...
Generated: `2026-09-19T19:56:04.657498+00:00`
...
Files: 1088; import sites: 3425; forbidden pairs: 0; analysis errors: 6; authority cycles: 0.
...
| `adapters` | `core` | 139 |
| `application` | `adapters` | 382 |
| `application` | `application` | 1649 |
| `application` | `core` | 739 |
