...
Generated: `2026-09-22T04:14:24.499039+00:00`
...
Files: 1125; import sites: 3625; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 141 |
| `application` | `adapters` | 421 |
| `application` | `application` | 1759 |
| `application` | `core` | 765 |
