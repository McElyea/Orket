...
Generated: `2026-09-23T23:59:00.673304+00:00`
...
Files: 1175; import sites: 3910; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 152 |
| `application` | `adapters` | 484 |
| `application` | `application` | 1922 |
| `application` | `core` | 792 |
