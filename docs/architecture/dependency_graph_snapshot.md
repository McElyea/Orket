...
Generated: `2026-09-23T04:21:24.642054+00:00`
...
Files: 1165; import sites: 3829; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 152 |
| `application` | `adapters` | 469 |
| `application` | `application` | 1857 |
| `application` | `core` | 791 |
