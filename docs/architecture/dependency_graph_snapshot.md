...
Generated: `2026-09-22T02:30:49.481361+00:00`
...
Files: 1117; import sites: 3593; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 141 |
| `application` | `adapters` | 420 |
| `application` | `application` | 1733 |
| `application` | `core` | 761 |
