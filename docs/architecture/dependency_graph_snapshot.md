...
Generated: `2026-09-22T05:09:14.959588+00:00`
...
Files: 1129; import sites: 3647; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 141 |
| `application` | `adapters` | 423 |
| `application` | `application` | 1774 |
| `application` | `core` | 770 |
