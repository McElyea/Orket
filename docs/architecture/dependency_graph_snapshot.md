...
Generated: `2026-09-22T05:48:26.226471+00:00`
...
Files: 1132; import sites: 3657; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 141 |
| `application` | `adapters` | 426 |
| `application` | `application` | 1777 |
| `application` | `core` | 773 |
