...
Generated: `2026-09-19T09:03:05.568075+00:00`
...
Files: 1060; import sites: 3334; forbidden pairs: 8; analysis errors: 8; authority cycles: 0.
...
| `adapters` | `application` | 3 |
| `adapters` | `core` | 138 |
| `application` | `adapters` | 356 |
| `application` | `application` | 1604 |
