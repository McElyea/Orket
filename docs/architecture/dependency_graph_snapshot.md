...
Generated: `2026-09-20T20:29:52.452214+00:00`
...
Files: 1099; import sites: 3474; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 139 |
| `application` | `adapters` | 394 |
| `application` | `application` | 1681 |
| `application` | `core` | 741 |
