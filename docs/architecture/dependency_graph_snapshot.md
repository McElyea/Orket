...
Generated: `2026-09-22T14:37:45.663349+00:00`
...
Files: 1146; import sites: 3738; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
|---|---|---:|
| `adapters` | `adapters` | 248 |
| `adapters` | `core` | 141 |
| `application` | `adapters` | 449 |
