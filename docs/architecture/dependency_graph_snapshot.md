...
Generated: `2026-09-22T08:07:35.942090+00:00`
...
Files: 1142; import sites: 3713; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
|---|---|---:|
| `adapters` | `adapters` | 244 |
| `adapters` | `core` | 141 |
| `application` | `adapters` | 440 |
