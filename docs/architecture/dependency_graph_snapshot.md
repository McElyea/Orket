...
Generated: `2026-09-22T07:29:48.884155+00:00`
...
Files: 1139; import sites: 3705; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 141 |
| `application` | `adapters` | 438 |
| `application` | `application` | 1803 |
| `application` | `core` | 782 |
