...
Generated: `2026-09-22T21:50:07.953887+00:00`
...
Files: 1158; import sites: 3797; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
|---|---|---:|
| `adapters` | `adapters` | 254 |
| `adapters` | `core` | 148 |
| `application` | `adapters` | 460 |
| `application` | `application` | 1843 |
