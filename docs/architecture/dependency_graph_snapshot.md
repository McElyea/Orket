...
Generated: `2026-09-22T12:24:39.927387+00:00`
...
Files: 1143; import sites: 3722; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
|---|---|---:|
| `adapters` | `adapters` | 246 |
| `adapters` | `core` | 141 |
| `application` | `adapters` | 447 |
| `application` | `application` | 1805 |
