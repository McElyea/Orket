...
Generated: `2026-09-22T06:40:06.507836+00:00`
...
Files: 1134; import sites: 3669; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
|---|---|---:|
| `adapters` | `adapters` | 242 |
| `adapters` | `core` | 141 |
| `application` | `adapters` | 428 |
| `application` | `application` | 1783 |
| `application` | `core` | 777 |
