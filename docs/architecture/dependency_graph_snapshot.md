...
Generated: `2026-09-23T19:20:21.595684+00:00`
...
Files: 1166; import sites: 3839; forbidden pairs: 0; analysis errors: 0; authority cycles: 0.
...
| `adapters` | `core` | 152 |
| `application` | `adapters` | 470 |
| `application` | `application` | 1863 |
| `application` | `core` | 794 |
