...
remaining synchronous ConfigLoader callers, API observation/replay reads and
full D/E/CAP acceptance remain open. Proof records distinguish controlled local
