...
This document is the canonical active implementation authority for the `Extension Publish Surface Hardening` lane recorded in `docs/ROADMAP.md`.
...
No separate requirements lane is required unless this publish lane starts widening beyond the decision lock below.
...
9. `.gitea/workflows/sdk-package-release.yml`
...
8. `.gitea/workflows/sdk-package-release.yml`
...
The existing `.gitea/workflows/sdk-package-release.yml` surface is valid proof input for the tag-version discipline expected here.
