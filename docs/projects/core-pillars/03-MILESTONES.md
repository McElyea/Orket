...
11. CP-4 WorkItem Runtime Refactor: completed.
12. CP-4.1 WorkItem core contract and transition API: completed.
13. CP-4.2 Profile system and legacy freeze: completed.
14. CP-4.3 New default profile switch path (`project_task_v1`): completed (switch flag path landed).
15. CP-4.4 Gate boundary consolidation: completed.
16. CP-4.5 Migration and cutover safety: completed (deterministic mapper + dry-run report + lossless fixture landed).
