...
## 3. Reviewed inputs and interpretation boundary

Sections 4 and 5 are the parts of this memo that make direct use of reviewed snapshot inputs.

Sections 6 through 10 are not direct snapshot claims.
They are interpretation and brainstorm material informed by the reviewed inputs plus explicit outside-framework comparison.

Reviewed inputs for Sections 4 and 5:
- `docs/ROADMAP.md`
- `README.md`
- `pyproject.toml`
...
- if a statement appears in Sections 4 or 5 and depends on these reviewed files, it is a snapshot observation only,
- if a statement appears in Sections 6 through 10, it should be read as interpretation or brainstorm direction informed by the reviewed inputs, not as a direct repo-state observation.
