...
242. `$env:ORKET_DISABLE_SANDBOX='1'; python -m pytest -q tests/runtime/test_controller_dispatcher.py tests/runtime/test_extension_manager.py tests/application/test_control_plane_workload_authority_governance.py tests/platform/test_current_authority_map.py`
