...
## Completion Evidence
1. `python scripts/governance/check_dependency_direction.py --legacy-edge-enforcement fail` passes.
2. `python scripts/benchmarks/check_volatility_boundaries.py` passes.
