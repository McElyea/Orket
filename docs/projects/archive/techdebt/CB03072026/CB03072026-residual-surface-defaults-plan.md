...
Cover the driver, extension, policy-default, and small interface-surface findings from `docs/projects/archive/techdebt/CB03072026/ClaudeBehavior.md` that were not explicitly enumerated in `docs/projects/archive/techdebt/CB03072026/CB03072026-claude-behavior-remediation-plan.md`.
