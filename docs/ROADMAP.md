...
|---|---|---|---|---|---|
| SDK | active | P1 | `docs/projects/SDK/` | Orket Core | Active roadmap lane. Phase 2 complete; Phase 3 bridge-side SDK integration started; Phase 5 docs and Phase 6 hardening in progress (artifact security tests + latency baseline runner landed). |
