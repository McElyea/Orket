...
|---|---|---|---|---|---|
| architectural-truth | active-implementation | P1 | `docs/projects/architectural-truth/` | Orket Core | Execute C/D dependency enforcement, core purity and async safety, then quality and capability gates; scoped BT-1 through BT-5 accepted. |
...
| future | staged+backlog-root | P3-backlog | `docs/projects/future/` | Orket Core | Incubation container for deferred lanes that are not yet part of an active non-archive project lane, including remaining outward proof-kernel extensions and formal methods. |
