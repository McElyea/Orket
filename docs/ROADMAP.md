...
## Priority Now
1. `OS`: active v1.2 closeout (`docs/projects/OS/v1.2/pr-workboard.md`), current slice `Closeout Step`.
...
|---|---|---|---|---|---|
| OS | active | P1 | `docs/projects/OS/` | Orket Core | v1.2 PR-01..PR-07 are complete. Remaining work is closeout: test-policy alignment and execution-pack archive decision (`docs/projects/OS/v1.2/pr-workboard.md`). |
