...
## Priority Now
1. `core-pillars`: execute CP-4 WorkItem runtime refactor slices (`docs/projects/core-pillars/11-WORKITEM-RUNTIME-IMPLEMENTATION-SLICES.md`).
2. `core-pillars`: maintain canonical contracts (`docs/projects/core-pillars/10-WORKITEM-RUNTIME-REQUIREMENTS.md`, `docs/projects/core-pillars/01-REQUIREMENTS.md`).
...
|---|---|---|---|---|---|
| core-pillars | active | P1 | `docs/projects/core-pillars/` | Orket Core | CP-1 through CP-3.3 complete; CP-4 WorkItem runtime refactor is current active slice lane. |
