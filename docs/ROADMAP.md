...
## Active Execution
1. marshaller -- Execute v0 slices from `docs/projects/marshaller/Marshaller-v0.md` (current slice: Stage 0/1 intake contracts and deterministic rejection codes).
...
| marshaller | active | P1-active | `docs/projects/marshaller/` | Orket Core | Marshaller v0 specification and implementation lane; implementation started with intake contract + Stage 0/1 validation slice. |
