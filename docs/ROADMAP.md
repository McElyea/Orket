...
## Priority Now
1. `OS`: active v1.2 execution (`docs/projects/OS/v1.2/pr-workboard.md`), current slice `PR-06`.
...
|---|---|---|---|---|---|
| OS | active | P1 | `docs/projects/OS/` | Orket Core | v1.2 execution is active; PR-01..PR-05 complete and PR-06 kernel decision-record emission wiring in progress (`docs/projects/OS/v1.2/pr-workboard.md`). |
