...
## Priority Now
1. `OS`: active v1.2 execution (`docs/projects/OS/v1.2/pr-workboard.md`), current slice `PR-07`.
...
|---|---|---|---|---|---|
| OS | active | P1 | `docs/projects/OS/` | Orket Core | v1.2 execution is active; PR-01..PR-06 complete and PR-07 turn-result digest surface implementation in progress (`docs/projects/OS/v1.2/pr-workboard.md`). |
