...
Current default target: no active projects (last completed: `model-streaming` on 2026-02-28).

## Priority Now
1. `model-streaming`: completed and archived (`docs/projects/archive/Model-Streaming-2026-02-28/`).
