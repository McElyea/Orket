...
|---|---|---|---|---|---|
| SDK | active | P1 | `docs/projects/SDK/` | Orket Core | Active roadmap lane. Phase 2 complete; Phase 3 direct local-contract SDK bridge + determinism coverage landed; Phase 4 Meta Breaker scenario pack + Reforger route bootstrap landed; Phase 5 docs and Phase 6 hardening are complete. |
