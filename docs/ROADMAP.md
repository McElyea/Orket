...
|---|---|---|---|---|---|
| OS | active | P1 | `docs/projects/OS/` | Orket Core | Execute `docs/projects/OS/IMPLEMENTATION_PLAN.md`; Phase B + baseline Phase F guardrails are landed and green locally, next focus is Phase E validator boundary + tombstone runtime validation closure. |
