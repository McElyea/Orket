...
| protocol-governed | active | P1-closed | `docs/projects/protocol-governed/` | Orket Core | Active folder holds contract/schema docs (`requirements.md`, `local-prompting-requirements.md`, `determinism-control-surface.md`, `error-code-registry.md`, `replay-campaign-schema.md`, `ledger-parity-campaign-schema.md`); completed execution artifacts archived at `docs/projects/archive/protocol-governed/PG03062026/`; recurring freshness work moved to `docs/projects/techdebt/Recurring-Maintenance-Checklist.md`. |
