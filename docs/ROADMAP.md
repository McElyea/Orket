...
1. core runtime requirements implementation plan: `docs/projects/core/runtime_requirements_implementation_plan.md`
2. core runtime requirements slice workboard: `docs/projects/core/runtime_requirements_slice_workboard.md`
3. techdebt recurring maintenance checklist (maintenance lane): `docs/projects/techdebt/Recurring-Maintenance-Checklist.md`
4. techdebt folder governance: `docs/projects/techdebt/README.md`
...
Current default target: core runtime requirements implementation lane.

## Priority Now
1. core runtime requirements implementation lane -- Execute `docs/projects/core/runtime_requirements_implementation_plan.md` and track status in `docs/projects/core/runtime_requirements_slice_workboard.md`.
...
| techdebt | maintenance | P3-maintenance | `docs/projects/techdebt/` | Orket Core | Standing maintenance lane. Run `Recurring-Maintenance-Checklist.md` each cycle, keep `G1`-`G7`/protocol/local-prompting freshness artifacts current, and apply `techdebt/README.md` archive semantics so non-maintenance cycle docs can close out. |
