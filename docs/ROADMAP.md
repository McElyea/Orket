...
|---|---|---|---|---|---|
| OS | active | P1 | `docs/projects/OS/` | Orket Core | Execute `docs/projects/OS/IMPLEMENTATION_PLAN.md`; Phase B + baseline Phase F guardrails are landed and green locally, validator boundary and tombstone runtime validation are now in place; next focus is schema-level strictness and kernel-law test-home consolidation. |
