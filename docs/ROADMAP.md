...
## Priority Now
1. `core-pillars`: canonical v1 slice map complete; maintain contracts and runbook artifacts (`docs/projects/core-pillars/03-MILESTONES.md`).
...
|---|---|---|---|---|---|
| core-pillars | active | P1 | `docs/projects/core-pillars/` | Orket Core | CP-1 through CP-3.3 complete on canonical slice plan; maintain as active contract source. |
