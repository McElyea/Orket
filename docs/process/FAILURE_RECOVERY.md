...
1. Run migrations:
```bash
python scripts/governance/run_migrations.py
```
...
3. `python scripts/governance/run_cli_regression_smoke.py --out benchmarks/results/governance/cli_regression_smoke.json`
