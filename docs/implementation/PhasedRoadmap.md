...
1. Add VRAM fragmentation analyzer experiments.
2. Add model selector and adaptive routing prototypes after diagnostics evidence is stable.

Next execution slice:
1. Add sidecar schema spec under `docs/specs/SIDECAR_PARSE_SCHEMA.md`. Status: done (2026-02-21)
2. Add contract test coverage for sidecar schema tokens. Status: done (2026-02-21)
3. Link sidecar spec from docs index. Status: done (2026-02-21)
