...
from orket_extension_sdk import AgentEffectProposal, AgentIterationRequest
...
async def test_effect_approval_pauses_then_resumes_with_verified_receipts(
    ...
    for proposal in proposals:
        ...
        checkpoint_ref = str(resolved.accepted_checkpoint_ref or "")
    ...
    resumed = await resume.prepare_resume(
        ...
        accepted_checkpoint_ref=checkpoint_ref,
    ...
    assert second_snapshot.request_payload["accepted_checkpoint_ref"] == checkpoint_ref
