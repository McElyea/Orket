...
def test_evaluator_emits_warning_when_conflict_disappears_without_marker() -> None:
    module = _load_script_module("evaluate_odr_calibration_bundle_test", "scripts/odr/evaluate_odr_calibration_bundle.py")
    bundle = {
        "runs": [
            {
                "run_id": "r1",
...
def test_evaluator_marks_format_violation_on_parse_or_code_leak() -> None:
    module = _load_script_module("evaluate_odr_calibration_bundle_test_fmt", "scripts/odr/evaluate_odr_calibration_bundle.py")
    bundle = {
        "runs": [
            {
                "run_id": "r2",
