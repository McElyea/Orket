...
def _load_script_module():
    ...
    spec = importlib.util.spec_from_file_location("register_meta_breaker_extension", script_path)
...
def test_register_meta_breaker_extension_writes_sdk_manifest_and_catalog(tmp_path, monkeypatch):
    ...
    extension_dir = tmp_path / "workspace" / "live_ext" / "meta_breaker"
    ...
    assert "entrypoint: meta_breaker_extension:run_workload" in manifest_text
