...
def test_score_report_emits_per_task_and_tier_aggregates() -> None:
    score_module = _load_script_module("score_benchmark_run_a", "scripts/benchmarks/score_benchmark_run.py")
...
def test_scoring_gate_fails_when_metadata_missing() -> None:
    gate_module = _load_script_module("check_benchmark_scoring_gate_a", "scripts/benchmarks/check_benchmark_scoring_gate.py")
    policy = json.loads(Path("model/core/contracts/benchmark_scoring_policy.json").read_text(encoding="utf-8"))
...
def test_scoring_gate_passes_for_good_report() -> None:
    score_module = _load_script_module("score_benchmark_run_b", "scripts/benchmarks/score_benchmark_run.py")
