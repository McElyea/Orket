...
from scripts.governance.check_feature_flag_expiration_policy import (
    check_feature_flag_expiration_policy,
...
# Layer: contract
def test_evaluate_feature_flag_expiration_policy_passes_for_current_contract() -> None:
...
# Layer: integration
def test_check_feature_flag_expiration_policy_writes_diff_ledger_payload(tmp_path: Path) -> None:
    out_path = tmp_path / "feature_flag_expiration_policy_check.json"
