...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Stability loops for scripts/run_model_streaming_gate.py (0 disables stream gate).",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=1000,
        help="Loop count for scripts/real_service_stress.py (0 disables stress suite).",
    )
    parser.add_argument(
        "--stress-profile",
