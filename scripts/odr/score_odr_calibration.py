...
def main() -> int:
    ...
    parser.add_argument("--eval", default="benchmarks/results/odr/odr_calibration/evaluation_v1.json")
    parser.add_argument("--gold", default="benchmarks/results/odr/odr_calibration/gold_labels_v1.json")
    parser.add_argument("--out", default="benchmarks/results/odr/odr_calibration/score_v1.json")
