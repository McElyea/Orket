...
def main() -> int:
    ...
    parser.add_argument("--bundle", default="benchmarks/results/odr/odr_calibration/candidate_runs_v1.json")
    parser.add_argument("--out", default="benchmarks/results/odr/odr_calibration/evaluation_v1.json")
