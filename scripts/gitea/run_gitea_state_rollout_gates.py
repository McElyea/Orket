...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--out",
        default="benchmarks/results/gitea/gitea_state_rollout_gates.json",
...
def main() -> int:
    ...
    pilot_cmd = [
        sys.executable,
        "scripts/gitea/check_gitea_state_pilot_readiness.py",
        "--out",
        "benchmarks/results/gitea/gitea_state_pilot_readiness.json",
        "--require-ready",
    ]
    hardening_cmd = [
        sys.executable,
        "scripts/gitea/check_gitea_state_hardening.py",
        "--execute",
        "--out",
        "benchmarks/results/gitea/gitea_state_hardening_check.json",
        "--require-ready",
    ]
    phase3_cmd = [
        sys.executable,
        "scripts/gitea/check_gitea_state_phase3_readiness.py",
        "--execute",
        "--pilot-readiness",
        "benchmarks/results/gitea/gitea_state_pilot_readiness.json",
        "--hardening-readiness",
        "benchmarks/results/gitea/gitea_state_hardening_check.json",
        "--out",
        "benchmarks/results/gitea/gitea_state_phase3_readiness.json",
        "--require-ready",
    ]
