...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--pilot-readiness",
        default="benchmarks/results/gitea/gitea_state_pilot_readiness.json",
        help="Pilot readiness artifact path.",
    )
    parser.add_argument(
        "--hardening-readiness",
        default="benchmarks/results/gitea/gitea_state_hardening_check.json",
        help="Hardening readiness artifact path.",
    )
    parser.add_argument(
        "--out",
        default="benchmarks/results/gitea/gitea_state_phase3_readiness.json",
