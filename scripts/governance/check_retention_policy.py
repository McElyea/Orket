...
def main() -> int:
    ...
    parser.add_argument("--plan", default="benchmarks/results/governance/retention_plan.json")
    parser.add_argument("--out", default="benchmarks/results/governance/retention_policy_check.json")
