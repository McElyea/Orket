...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-json", default="benchmarks/results/security/security_compat_expiry_check.json")
    parser.add_argument("--out-md", default="benchmarks/results/security/security_compat_expiry_check.md")
