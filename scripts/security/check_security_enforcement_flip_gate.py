...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ci-failure-json", default="benchmarks/results/ci/ci_failure_dump.json")
    parser.add_argument("--compat-warnings-json", default="benchmarks/results/security/security_compat_warnings.json")
    parser.add_argument("--compat-expiry-json", default="benchmarks/results/security/security_compat_expiry_check.json")
    parser.add_argument("--security-regression-json", default="benchmarks/results/security/security_regression_status.json")
    parser.add_argument("--out-json", default="benchmarks/results/security/security_enforcement_flip_gate.json")
    parser.add_argument("--out-md", default="benchmarks/results/security/security_enforcement_flip_gate.md")
