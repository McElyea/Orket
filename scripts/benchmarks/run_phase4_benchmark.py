...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--runner-template",
        default="python scripts/benchmarks/orchestration_runner.py --task {task_file} --venue {venue} --flow {flow} --run-dir {run_dir}",
    )
    parser.add_argument("--raw-out", default="benchmarks/results/benchmarks/phase4_determinism_report.json")
    parser.add_argument("--scored-out", default="benchmarks/results/benchmarks/phase4_scored_report.json")
