...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw-out", default="benchmarks/results/benchmarks/benchmark_determinism_report.json")
    parser.add_argument("--scored-out", default="benchmarks/results/benchmarks/benchmark_scored_report.json")
    parser.add_argument("--memory-trace", default="")
    parser.add_argument("--memory-retrieval-trace", default="")
    parser.add_argument("--memory-check-out", default="benchmarks/results/benchmarks/memory_determinism_check.json")
    ...
    parser.add_argument("--memory-compare-out", default="benchmarks/results/benchmarks/memory_determinism_compare.json")
