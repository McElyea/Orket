...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--raw-out", default="benchmarks/results/benchmarks/live_card_100_determinism_report.json")
    parser.add_argument("--scored-out", default="benchmarks/results/benchmarks/live_card_100_scored_report.json")
