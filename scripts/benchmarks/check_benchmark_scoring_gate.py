...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--scored-report", default="benchmarks/results/benchmarks/benchmark_scored_report.json")
    parser.add_argument("--policy", default="model/core/contracts/benchmark_scoring_policy.json")
    parser.add_argument("--out", default="benchmarks/results/benchmarks/benchmark_scoring_gate.json")
    parser.add_argument(
        "--require-thresholds",
        action="store_true",
...
def main() -> int:
    ...
    write_payload_with_diff_ledger(out_path, result)
