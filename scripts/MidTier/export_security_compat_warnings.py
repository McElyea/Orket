...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-json", default="benchmarks/results/security_compat_warnings.json")
    parser.add_argument("--out-md", default="benchmarks/results/security_compat_warnings.md")
