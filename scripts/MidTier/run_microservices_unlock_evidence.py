...
def build_command_plan(args: argparse.Namespace) -> List[List[str]]:
    matrix_cmd = [
        "python",
        "scripts/MidTier/run_monolith_variant_matrix.py",
        "--execute",
        "--models",
        *list(args.models),
        "--iterations",
    ...
    live_loop_cmd = [
        "python",
        "-m",
        "scripts.MidTier.run_live_acceptance_loop",
        "--models",
        *list(args.models),
        "--iterations",
        str(args.iterations),
    ...
    unlock_cmd = [
        "python",
        "scripts/MidTier/check_microservices_unlock.py",
        "--matrix",
        str(args.matrix_out),
        "--readiness-policy",
    ...
    decision_cmd = [
        "python",
        "scripts/LowTier/decide_microservices_pilot.py",
        "--unlock-report",
        str(args.unlock_out),
        "--out",
