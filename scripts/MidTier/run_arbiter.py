    ...
    def compile_plan(
        ...
        *,
        ...
        materials: list[PlanMaterial] = [
            ...
            PlanMaterial(kind="file", value="scripts/HighTier/run_odr_live_role_matrix.py"),
            PlanMaterial(kind="file", value="scripts/MidTier/generate_odr_role_matrix_index.py"),
        ]
        if require_provenance:
            materials.append(PlanMaterial(kind="file", value="scripts/MidTier/generate_odr_provenance.py"))
