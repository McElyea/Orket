...
E_AGENT_INVOCATION_OWNER_PREFIX: Final[str] = "E_AGENT_INVOCATION_OWNER"
...
_PREFIX_CODES: Final[dict[str, str]] = {
    ...
    E_AGENT_INVOCATION_OWNER_PREFIX: "Governed native invocation refused an incompatible lifetime owner.",
