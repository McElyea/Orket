...
def build_orchestrator_support_services() -> OrchestratorSupportServices:
    return OrchestratorSupportServices(
        scaffolder_cls_getter=lambda: Scaffolder,
        dependency_manager_cls_getter=lambda: DependencyManager,
        deployment_planner_cls_getter=lambda: DeploymentPlanner,
        runtime_verifier_cls_getter=lambda: RuntimeVerifier,
        prompt_compiler_cls_getter=lambda: PromptCompiler,
        prompt_resolver_cls_getter=lambda: PromptResolver,
        load_user_settings_getter=lambda: load_user_settings,
    )
