...
class DependencyManager:
    ...
    def _build_profile_files(
        ...
        if stack_profile in {"python", "polyglot"}:
            ...
            package_name = (
                str(rules.get("dependency_manager_python_package_name", "orket-generated-project")).strip()
                or "orket-generated-project"
            )
            package_version = str(rules.get("dependency_manager_python_package_version", "0.1.0")).strip() or "0.1.0"
            package_description = (
                str(rules.get("dependency_manager_python_description", "Generated by Orket")).strip()
                or "Generated by Orket"
            )
        ...
        if stack_profile in {"node", "polyglot"}:
            ...
            node_name = (
                str(rules.get("dependency_manager_node_package_name", "orket-generated-project")).strip()
                or "orket-generated-project"
            )
    ...
    def _validate_pinned_node(dependencies: Dict[str, str]) -> None:
        for name, version in dependencies.items():
            ...
            if version and version[0].isdigit():
                continue
            raise DependencyValidationError(f"node dependency '{name}' has non-pinned version '{version}'.")
