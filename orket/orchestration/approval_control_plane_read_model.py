...
def operator_action_summary(record: Any) -> dict[str, Any]:
    return {
        ...
        "risk_acceptance_scope": record.risk_acceptance_scope,
        "attestation_scope": record.attestation_scope,
        "attestation_payload": dict(record.attestation_payload),
        "precondition_basis_ref": record.precondition_basis_ref,
