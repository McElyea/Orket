...
Planned S3 URI: `s3://<replace-with-globally-unique-smoke-bucket>/orket/trusted-terraform-plan-decision/terraform-plan-safe-smoke.plan.json`
Planned DynamoDB table: `TerraformReviews`
